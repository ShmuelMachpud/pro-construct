...
import { register, login, approveUser, getPendingContractors, getAllUsers } from "../controllers/auth.controller";
...
authRouter.get("/users", authenticate, authorize(UserRole.ADMIN, UserRole.OPERATOR), getAllUsers);
